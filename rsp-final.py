...
class user(Player):
    ...
    def move(self):
        user_move = input("choose a move : (rock , scissors, paper)").lower()
...
class Game:
    ...
    def play_round(self):
        ...
        if move1 == move2:
            ...
            self.p1.score += 1 
            print("player 1 wins", "player's score is =", str(self.p1.score))

        else:
            self.p2.score += 1
            print("player 2 wins", "player's score is =", str(self.p2.score))
    ...
    def play_game(self):
        ...
        for item in range(int(round)):
            ...
            self.play_round()
        print("Game over!")
        print("p1 =", str(self.p1.score), "p2 =", str(self.p2.score))
...
if __name__ == '__main__':
    ...
    type_of_game = ["random", "cycler", "repeat", "reflect"]
    while game_type not in type_of_game :
        print("Invalid input! try again")
        game_type = input("choose a game style: (random, cycler, repeat, reflect)")
    if game_type == "random":
